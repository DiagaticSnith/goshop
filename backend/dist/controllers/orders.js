...
const getAllOrders = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const [orders, total] = yield Promise.all([
            ...
            prisma_client_1.default.order.count({ where })
        ]);
        return res.status(200).json({ data: orders, total, page: parseInt(page, 10), pageSize: take });
    }
    catch (error) {
...
const rejectOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        try {
            ...
            try {
                (yield Promise.resolve().then(() => __importStar(require('../utils/metrics')))).stripeErrors.inc({ type: 'refund' });
            }
            catch (err) { }
        }
