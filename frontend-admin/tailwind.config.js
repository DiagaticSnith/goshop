...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      dropShadow: { custom: "0px 1px 2px 0px rgba(51, 65, 86, 0.08)" },
      backgroundImage: {
      ...
      boxShadow: { blur: "0px 12px 16px -4px rgba(12, 26, 36, 0.04)" },
      keyframes: {
        dropdownScale: { "0%": { transform: "scale(0)" }, "100%": { transform: "scale(1)" } },
        fadeIn: {
          "0%": { opacity: 0.2 },
          "25%": { opacity: 0.4 },
          "50%": { opacity: 0.6 },
      ...
      animation: { dropdown: "dropdownScale .2s", fadeIn: "fadeIn .2s ease-in-out" },
    },
  },
  plugins: [],
}
